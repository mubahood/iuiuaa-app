...
class TwitterColor {
  static final Color bondiBlue = Color.fromRGBO(0, 153, 0, 1.0);
  static final Color cerulean = Color.fromRGBO(0, 153, 0, 1.0);
  ...
  static final Color dodgetBlue = Color.fromRGBO(0, 153, 0, 1.0);
...
class AppColor {
  static final Color primary = Color.fromRGBO(0, 153, 0, 1.0);
